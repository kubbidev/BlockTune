...
public final class MathUtil {
    ...
    public static BlockFace getHorizontalDirection(float yawInDegrees) {
        ...
        if (directionIndex < 0) {
            directionIndex = (-directionIndex) % MathUtil.HORIZONTAL.length;
            directionIndex = MathUtil.HORIZONTAL.length - directionIndex;
        }
        directionIndex %= MathUtil.HORIZONTAL.length;
        return HORIZONTAL[directionIndex];
    }
