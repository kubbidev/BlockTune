...
public enum Ability {
     ...
     * <p>
     * This handler encapsulates the logic required to apply the spell's effects, ensuring that the spell behaves as intended when cast by
     * an entity.
     */
     ...
     * <p>
     * These parameters define the core attributes of the spell, they are used to initialize the spell with consistent, balanced values
    ...
    /**
     * Converts this enumeration into a {@link Spell} that can be utilized by the plugin.
     * <p>
     * This method creates a new {@link SimpleSpell} instance, associates it with the appropriate handler, and registers the default
     * parameters.
     * <p>
     * This method ensures that the spell is properly configured and ready for use, leveraging the predefined settings encapsulated in the
     * enum.
     * </p>
     *
    ...
    public Spell toSpell() {
        SimpleSpell spell = new SimpleSpell(SpellCasterProvider.get(), TriggerType.API, this.handler);
