...
public class MultiConfigurationAdapter implements ConfigurationAdapter {
     ...
     */
    public MultiConfigurationAdapter(BlockTune plugin, List<ConfigurationAdapter> adapters) {
        this.plugin = plugin;
        this.adapters = ImmutableList.copyOf(adapters).reverse();
    }

    public MultiConfigurationAdapter(BlockTune plugin, ConfigurationAdapter... adapters) {
