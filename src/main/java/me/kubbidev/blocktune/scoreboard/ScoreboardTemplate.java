...
public class ScoreboardTemplate {
    ...
    public static final String[] SERVER_ADDRESS = {
        "<gold>kubbidev.me</gold>",
        "<gold><yellow>k</yellow>ubbidev.me</gold>",
        "<gold><yellow><white>k</white>u</yellow>bbidev.me</gold>",
        "<gold><yellow>k<white>u</white>b</yellow>bidev.me</gold>",
        "<gold>k<yellow>u<white>b</white>b</yellow>idev.me</gold>",
        "<gold>ku<yellow>b<white>b</white>i</yellow>dev.me</gold>",
        "<gold>kub<yellow>b<white>i</white>d</yellow>ev.me</gold>",
        "<gold>kubb<yellow>i<white>d</white>e</yellow>v.me</gold>",
        "<gold>kubbi<yellow>d<white>e</white>v</yellow>.me</gold>",
        "<gold>kubbid<yellow>e<white>v</white>.</yellow>me</gold>",
        "<gold>kubbide<yellow>v<white>.</white>m</yellow>e</gold>",
        "<gold>kubbidev<yellow>.<white>m</white>e</yellow></gold>",
        "<gold>kubbidev.m<yellow>e</yellow></gold>",
        "<gold>kubbidev.me</gold>"
    };
