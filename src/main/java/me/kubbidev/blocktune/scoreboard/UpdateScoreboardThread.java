...
public class UpdateScoreboardThread implements Consumer<Task> {
    private final Player player;

    private final ScoreboardManager scoreboardManager;
    private final Scoreboard scoreboard;

    public UpdateScoreboardThread(@NotNull ScoreboardManager scoreboardManager, @NotNull Scoreboard scoreboard) {
